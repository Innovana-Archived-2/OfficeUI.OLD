...
$.fn.RibbonFromJson = function (jsonUrl, options) {
    ...
    // End of section: Ribbon API.
}

// Section: Helper namespace with some common functions.
...
// End of section: Helper namespace with some common classes.